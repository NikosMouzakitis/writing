...
\begin{document}
	...
	\section*{Bibliographical references}
		...
		\section{Filtering}
			...
			The filter with the lowest average rank was considered the best compromise between noise reduction and signal fidelity. According to this evaluation, the \textbf{DB4, Level 2, Threshold 0.5, Hard Thresholding} filter achieved the highest overall performance, exhibiting:
			\begin{itemize}
			    \item One of the highest SNR values,
			    \item Lowest RMSE and NRMSE values,
			    \item Highest correlation coefficient,
			    \item Lowest PRD.
			\end{itemize}
			This indicates that the chosen filter effectively suppressed noise while preserving the morphological features of the EEG signal, making it the most suitable choice for subsequent analysis.
